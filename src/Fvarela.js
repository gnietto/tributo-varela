...
function Fvarela(props){
	...
	<>
		...
		<Header as='h3' textAlign='centered'>Santiago (Chile), 1946 - París (Francia), 2001</Header>
		<Grid padded stackable>
			<Grid.Row>
				<Grid.Column width={7} textAlign='justified'>
				...
				<Grid.Column width={9} textAlign='justified'>					
